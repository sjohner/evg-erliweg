...
- [X] T003 Update index.html to keep a single stylesheet entry point pointing to assets/css/styles.css
...
## Phase 3: User Story 1 - Browse Updated Homepage with Modern Section Navigation (Priority: P1) MVP

Goal: Deliver a modern homepage with clear hierarchy and section-based in-page navigation.

Independent Test: From index.html, a user can identify purpose within 5 seconds, navigate via in-page links, and use keyboard focus states across hero actions and interactive elements.

- [X] T011 [P] [US1] Update hero information hierarchy and CTA grouping in index.html with semantic heading flow and clear in-page links to history and about sections
...
- [X] T013 [P] [US1] Implement stable header container behavior in assets/css/components.css for .site-header with non-obscuring spacing
- [X] T014 [P] [US1] Implement link and control hover/focus-visible styling in assets/css/components.css and assets/css/accessibility.css
...
Independent Test: Data sections on index.html render as rounded, bordered cards with readable type, spacing, and subtle interactive feedback.
...
- [X] T019 [P] [US2] Standardize historical chart card styling for index.html in assets/css/components.css with consistent surface, border, and heading treatment
...
- [X] T023 [US2] Add lazy-loading and intrinsic sizing attributes where applicable in index.html for visualization-related media
- [X] T024 [US2] Run data-view acceptance checks from specs/003-github-design-modernization/spec.md against index.html and log results in specs/003-github-design-modernization/quickstart.md

Checkpoint: US2 is independently functional and testable.

---

## Phase 5: User Story 3 - Navigate Single-Page Sections with Consistent Styling (Priority: P1)

Goal: Apply one consistent visual and interaction system across all major sections in index.html.

Independent Test: Navigating between home/data/history/about sections preserves shared header/footer styling, typography scale, component behavior, and accent usage.

- [X] T025 [P] [US3] Align shared header and section-link behavior in index.html for consistent section navigation and reading order
- [X] T026 [P] [US3] Align shared footer and end-of-page spacing treatment in assets/css/components.css
- [X] T027 [P] [US3] Normalize section heading, paragraph, list, and metadata typography across all content sections using assets/css/styles.css
- [X] T028 [P] [US3] Normalize card variants to match metric/history/about cards in assets/css/components.css
- [X] T029 [US3] Ensure all interactive elements across the single page share identical focus-visible behavior via assets/css/accessibility.css
- [X] T030 [US3] Run cross-section consistency checks from specs/003-github-design-modernization/spec.md and record outcomes in specs/003-github-design-modernization/quickstart.md
...
- [X] T032 [P] [US4] Verify and tune form controls, chart area, and history cards on index.html at all required breakpoints in assets/css/layout.css
- [X] T033 [P] [US4] Verify and tune info-card and long-text layouts on index.html at all required breakpoints in assets/css/layout.css
...
- [X] T038 [P] [US5] Run keyboard and semantic structure checks for index.html and fix issues in markup and assets/css/accessibility.css
